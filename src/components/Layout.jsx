...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 dark:bg-slate-950 bg-grid-pattern relative flex flex-col text-slate-300 font-sans transition-colors duration-300">
      
      {/* HEADER */}
      <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-slate-950/80 border-b border-cyan-500/20 shadow-[0_4px_30px_rgba(34,211,238,0.1)]">
